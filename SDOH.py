...
def main():
    ...
    # Define file paths
    sdoh_file = 'SDOH_2020_ZIPCODE_1_0.xlsx'
    zip_crosswalk_file = 'zip_code_database.csv'
    hpsa_file = 'all-primary-care-hpsas.xlsx'
    aqi_file = 'annual_aqi_by_county_2024.csv'
    chr_file = '2023 County Health Rankings Data - v2.xlsx'
